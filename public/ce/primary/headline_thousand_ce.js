...
class HeadlineThousandCE extends HeadlineBaseCE {
	constructor() {
		super();
		this.stream = "title";
		this.tpl = tpl;
	...
	extendBaseView(that, model) {
		this.view.renderTitle = function (obj) {
			...
			this.render(helloTemplate(separatedNumbers), headline);
		};
...
window.customElements.define('headline-thousand-ce', HeadlineThousandCE);
