...
document.addEventListener('DOMContentLoaded', function() {
    ...
    .then(function (db) {
        ...
        updateFromDataKindElements(elementsOfKind, 'rent', serializedNonsensFunction);

        /**
         * Saves info from DOM to db
         * @param {*} elements array with DOM elements
            ...
            function updateFromDataKindElsRecursive(elements, dataKind, serializedFunction) {
                ...
                if (dbId === "") {
                    ...
                    let doc = {
                        ...
                        elementValue: helper.dom.getAttribute('value', elements[0]),
                    ...
                    let doc = getDoc(doc._id, db)
                        .then((doc) => {
                            //updates document value on database
                            doc.elementValue = helper.dom.getAttribute('value', elements[0]);
                            //updates written 
