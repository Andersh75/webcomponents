...
//BACKUP
        ...
        createBoxForSection: my.curry(function (holderId, db, partId, order) {
            ...
            let elementDiv = h.dom.createElement('section-parmaco');

            h.dom.setAttribute('id', partId + '-section-box', elementDiv);
            h.dom.setAttribute('kind', 'section-box', elementDiv);
        ...
        createSection: my.curry(function (sectionName, db, order, docId, doc, controller) {
            views.parmaco.createBoxForSection('main', db, docId, order);
